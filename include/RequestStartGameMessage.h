...
#ifndef CPP_INDIE_STUDIO_HOSTCONFIGURATIONMESSAGES_H
#define CPP_INDIE_STUDIO_HOSTCONFIGURATIONMESSAGES_H
...
#endif //CPP_INDIE_STUDIO_HOSTCONFIGURATIONMESSAGES_H
